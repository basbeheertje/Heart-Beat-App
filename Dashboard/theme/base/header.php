							...
							<li>
								<ul class="dropdown-menu-list scroller" style="height: 250px;">
									<li>
										...
										<span class="photo">
											<img src="<?php echo $this->themeUrl(); ?>/img/avatar2.jpg" alt=""/>
										</span>
										<span class="subject">
											<span class="from">
												Lisa Wong
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
											<img src="<?php echo $this->themeUrl(); ?>/img/avatar3.jpg" alt=""/>
										</span>
										<span class="subject">
											<span class="from">
												Richard Doe
									...
									<li>
										<a href="inbox.html?a=view">
										<span class="photo">
											<img src="<?php echo $this->themeUrl(); ?>/img/avatar1.jpg" alt=""/>
										</span>
										<span class="subject">
											<span class="from">
												Bob Nilson
